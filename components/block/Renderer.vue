  ...
  export default Vue.extend({
    ...
    methods: {
      ...
      initThree(): void {
        ...
        new RGBELoader()
          .setPath('/hdr/')
          .load('dikhololo_night_2k.hdr', (hdrmap) => {
            ...
            box1Material.bumpMap.repeat.set(box1.scale.x, box1.scale.y);
            box1Material.roughnessMap.repeat.set(box1.scale.x, box1.scale.y);
